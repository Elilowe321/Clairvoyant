...
def gradient_boost(df):
    ...
    # Save models
    dump(classification_model, filename="cfb_models/gradient_classification_model.joblib")
    dump(regression_model_home, filename="cfb_models/gradient_model_home.joblib")
    dump(regression_model_away, filename="cfb_models/gradient_model_away.joblib")
...
def random_forest(df):
    ...
    dump(
        ...
        filename="cfb_models/random_forest_classification_model.joblib",
    )
    dump(regression_model, filename="cfb_models/random_forest_model.joblib")
...
def user_created_model(user_id, name, df, description=None):
    ...
    # Save models
    class_file_name = f"cfb_models/{user_id}_class_{name}.joblib"
    reg_file_name = f"cfb_models/{user_id}_reg_{name}.joblib"
...
def target_provided(user_id, name, df, type, target, description=None):
    ...
    if type == "regression":
        ...
        reg_file_name_home = f"cfb_models/{user_id}_gradient_reg_home_{name}.joblib"
        reg_file_name_away = f"cfb_models/{user_id}_gradient_reg_away_{name}.joblib"
